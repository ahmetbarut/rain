<form class="needs-validation" name="frm_off_personalaccident" id="off_personalaccident" method="post">
    ...
    <div class="modal-body">
        <div class="input-group mb-2">
            <input name="identity" maxlength="11" autocomplete="off" type="text" class="form-control" placeholder="<?= __("all.identity_number") ?>" data-toggle="tooltip" data-placement="top" title="<?= __("all.identity_number_description") ?>">
        </div>
        <div class="input-group mb-2">
            <select class="selects form-control" name="limit" data-toggle="tooltip" data-placement="top" title="<?= __("all.personal_accident_limit") ?>">
        ...
        <div class="input-group mb-2">
            <input name="phoneNumber" maxlength="14" type="text" class="form-control btn-validation" placeholder="<?= __("all.phone_number") ?>" data-toggle="tooltip" data-placement="top" title="<?= __("all.phone_warning") ?>">
        </div>
        <div class="mt-3">
            <?php
