<form class="needs-validation" name="frm_off_traffic">
    ...
    <div class="modal-body">
        <div class="input-group mb-2">
            <input name="identity" maxlength="11" value="" onkeypress="" autocomplete="off"
                   type="text" class="identity form-control"
        ...
        <div class="input-group mb-2">
            <select class="form-control plaque is-invalid" name="plaque"
        ...
        <div class="input-group mb-2">
            <select class="form-control jobs" name="jobs" data-toggle="tooltip"
                    data-placement="top"
        ...
        <div class="input-group mb-2">
            <input name="phoneNumber" maxlength="14" id="" type="text"
