<form class="needs-validation" name="frm_off_traffic">
    ...
    <div class="text-center">
        <button type="button" onclick="validateForm('form[name=frm_off_traffic]','traffic','<?php echo path('offerView') ?>')" class="btn btn-primary mb-3 hvr-icon-forward"><i class="material-icons hvr-icon">chevron_right</i> <?= __("all.get_now_offer") ?>
        </button>
    </div>
</form>