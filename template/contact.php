<?php
app('view')->extends('layouts/home', ['title' => 'İletişim'])->startSection('content');
?>
...
<div class="container">
        ...
        <div class="m-none">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?= config("app.app_url") ?>"><?= __("all.home") ?></a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <form role="form" name="Proposal" id="Proposal" class="needs-validation" novalidate="novalidate"
                              method="post" action="<?= ("contact.save") ?>">
